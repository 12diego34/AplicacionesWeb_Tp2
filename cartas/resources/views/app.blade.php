            ...
            <div class="list-group panel">
                <ul class="nav navbar-nav">
                    ...
                    <div class="collapse" id="demo3">
                        ...
                        <a href="{{ URL::to('despido') }}" class="list-group-item" data-parent="#SubMenu1">Despido <i class="fa fa-caret-down"></i></a>
                        <a href="{{ URL::to('sancion') }}" class="list-group-item" data-parent="#SubMenu1">Sancion <i class="fa fa-caret-down"></i></a>                                                          
                        <a href="{{ URL::to('invitacion') }}" class="list-group-item" data-parent="#SubMenu1">Invitacion <i class="fa fa-caret-down"></i></a>                                                          
                        <a href="{{ URL::to('reclamo') }}" class="list-group-item" data-parent="#SubMenu1">Reclamo <i class="fa fa-caret-down"></i></a>                                                          
                    </div>
